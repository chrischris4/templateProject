<template>
    <!-- Image Grid -->
    <div class="flex flex-col  border-4 border-white/0 hover:border-blue-500 w-full pb-4 cursor-pointer">
        <h2 class=" text-2xl mt-8 mb-2 font-bold w-11/12 mx-auto">Gallery</h2>
        <div
            class="grid grid-cols-2 sm:grid-cols-3 gap-2 mx-auto relative w-11/12">
